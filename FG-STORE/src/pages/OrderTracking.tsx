      ...
      <div className="max-w-xl w-full bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-800 text-center animate-in zoom-in-95 duration-500 relative overflow-hidden">
        ...
        <div className="mb-12">
          {shippingStage === 0 && (
            <>
              ...
              <p className="text-gray-500 mt-2">We are packing your items right now.</p>
            </>
          )}
          {shippingStage === 1 && (
            <>
              <Truck className="w-16 h-16 text-blue-500 mx-auto mb-4 animate-pulse" />
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Out for Delivery!</h1>
              <p className="text-gray-500 mt-2">Your package is en route to your destination.</p>
            </>
          )}
          {shippingStage === 2 && (
            <>
              <CheckCircle className="w-16 h-16 text-green-500 mx-auto mb-4 animate-[ping_1s_cubic-bezier(0,0,0.2,1)_1]" />
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white text-green-600 dark:text-green-400">Delivered!</h1>
              <p className="text-gray-500 mt-2">Your items have been securely delivered. Enjoy!</p>
            </>
          )}
        </div>
        ...
        <div className="relative pt-4 pb-12">
          <div className="overflow-hidden h-2 mb-4 text-xs flex rounded-full bg-gray-200 dark:bg-gray-800">
            <div 
              style={{ width: shippingStage === 0 ? '15%' : shippingStage === 1 ? '60%' : '100%' }} 
          ...
          <div 
            ...
            style={{ left: shippingStage === 0 ? '15%' : shippingStage === 1 ? '60%' : '100%' }}
          >
            {shippingStage !== 2 && (
