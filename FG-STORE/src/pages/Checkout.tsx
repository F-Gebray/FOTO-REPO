    ...
    return (
      <div className="text-center py-24 px-4 h-[60vh] flex flex-col justify-center items-center">
        ...
        <p className="text-gray-500 mb-8">
          You haven't added any items to checkout yet.
        </p>
        <Link
          to="/"
          className="text-white bg-primary-600 hover:bg-primary-700 px-6 py-3 rounded-xl font-bold transition-colors"
        >
          Return to Shop
        </Link>
      </div>
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-950 min-h-screen pb-24">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-4 border-b border-gray-200 dark:border-gray-800 flex justify-between items-center mb-8">
        <Link
          to="/"
          className="text-gray-500 hover:text-gray-900 dark:hover:text-white flex items-center transition-colors"
        >
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 focus:ring-2 focus:ring-primary-500 outline-none transition-all text-gray-900 dark:text-white"
                    />
                  </div>
                </div>
              </div>
                  ...
                  <div className="col-span-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        maxLength={19}
                        className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 focus:ring-2 focus:ring-primary-500 outline-none transition-all text-gray-900 dark:text-white font-mono"
                      />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-8 border border-gray-100 dark:border-gray-800 shadow-sm sticky top-24 animate-in slide-in-from-right-4 duration-500">
              ...
              <div className="flex items-start gap-3 bg-gray-50 dark:bg-gray-800/50 p-4 rounded-xl">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                  Payments are secure and encrypted. Lumina Retail respects your
