...
const ProjectCard = ({
  ...
  return (
    <article
      ...
      h-full bg-[#020617] border border-[rgba(31,41,55,0.9)] rounded-[20px] 
      p-[1.1rem] shadow-[0_14px_30px_rgba(15,23,42,0.9)] 
      flex flex-col gap-[0.9rem] 
      hover:-translate-y-[3px] hover:shadow-[0_24px_50px_rgba(15,23,42,0.95)] 
      hover:border-[rgba(55,65,81,0.9)]"
    >
