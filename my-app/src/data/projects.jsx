...
const projects = [
  {
    ...
    liveUrl: "https://travel-plan-xi.vercel.app/",
...

  {
    ...
    description:
      "A sophisticated travel booking application tailored for luxury architectural stays. This platform features a dynamic property listing system, real-time date selection for reservations, and an integrated inquiry system powered by EmailJS. Built with a high-end dark aesthetic, it emphasizes seamless UX through responsive design and interactive SweetAlert2 notifications.",
    tech: [
      "React",
      "Vite",
      "Tailwind CSS",
