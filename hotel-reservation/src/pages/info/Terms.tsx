    ...
    <div className="max-w-7xl mx-auto px-4 py-8 w-full">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start gap-4 mb-6">
        <div>
          ...
          <div className="text-muted-foreground">Usage rules & conditions</div>
        </div>
      </div>
        ...
        <div className="flex-1">
          <section className="mb-12">
            ...
            <p className="text-muted-foreground text-lg">
              By using Stay-Comfort you agree to our booking terms.
            </p>
          </section>
        </div>
        ...
        <div className="w-full lg:w-[400px]">
          <div className="border rounded-2xl p-6 sticky top-24">
            ...
            <div className="space-y-3 text-sm">
              <div>✔ Fair usage</div>
              <div>✔ Booking policies apply</div>
              <div>✔ No abuse allowed</div>
            </div>
          </div>
        </div>
      </div>
