    ...
    <div className="w-full flex flex-col items-center py-16 px-4">
      <div className="max-w-3xl w-full text-center mb-16">
        ...
        <p className="text-lg text-muted-foreground">
          Have questions about a booking, our services, or want to partner with us? We'd love to hear from you.
        </p>
      </div>
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
        <div className="bg-card border border-border rounded-2xl p-6 flex flex-col items-center text-center shadow-sm">
          ...
          <p className="text-muted-foreground text-sm">+1 (800) 123-4567<br />Mon-Fri, 9am - 6pm EST</p>
        </div>
        <div className="bg-card border border-border rounded-2xl p-6 flex flex-col items-center text-center shadow-sm">
          <div className="h-12 w-12 bg-primary/10 text-primary rounded-full flex items-center justify-center mb-4">
          ...
          <p className="text-muted-foreground text-sm">support@stayscout.com<br />We reply within 24 hours</p>
        </div>
        <div className="bg-card border border-border rounded-2xl p-6 flex flex-col items-center text-center shadow-sm">
          <div className="h-12 w-12 bg-primary/10 text-primary rounded-full flex items-center justify-center mb-4">
          ...
          <p className="text-muted-foreground text-sm">123 Wanderlust Way<br />New York, NY 10001</p>
        </div>
      </div>
      ...
      <div className="w-full max-w-3xl bg-card border border-border rounded-3xl p-8 shadow-xl">
        {success ? (
          <div className="flex flex-col items-center py-12 text-center">
            ...
            <p className="text-muted-foreground mb-8">We've received your request and will get back to you shortly.</p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <Button type="submit" size="lg" className="h-12 text-lg">Send Message</Button>
          </form>
        )}
      </div>
    </div>
