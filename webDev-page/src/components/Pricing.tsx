...
const tiers = [
  ...
  },
  {
    ...
    features: ["Unlimited everything", "Dedicated account manager", "24/7 phone support", "SSO Authentication", "SLA included"],
    cta: "Contact Sales",
    popular: false
  }
];
    ...
    <section id="pricing" className="py-24 bg-[#050505] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center md:max-w-3xl mx-auto mb-16">
          <h2 className="text-cyan-400 font-semibold tracking-wide uppercase text-sm mb-3">Pricing</h2>
